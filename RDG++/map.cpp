...
void Map::init(std::shared_ptr<Player> player_)
{
	...
	placeInOverlay(Point{ 1, 1 }, game.getPrototypeStorage()->weaponFactory->create("Bow"));
	placeInOverlay(Point{ 2, 1 }, game.getPrototypeStorage()->weaponFactory->create("Longsword"));
